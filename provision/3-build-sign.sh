...
#
#   provision/3-build-sign.sh --ssid X --pass Y --supervisor <k> --keys mainToken,backupToken
...
#   --keys <a,b>        enrolled key names, first = primary, rest appended  (default: mainToken,backupToken)
...
SSID="" PASS="" SUP="" KEYS="mainToken,backupToken" OUTDIR="$SB/out" FEATURES="udp-transport,efuse-hmac-identity" SKIPBL=0 SECVER="" BUILDONLY=0
